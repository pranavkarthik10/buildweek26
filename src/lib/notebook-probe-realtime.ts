...
export function buildNotebookProbeRealtimeInstructions() {
  return [
    ...
    "For a new visual question, call request_ink_plan with the learner's exact question and wait for its authoritative visual plan.",
    ...
    "If no usable visual plan is supplied, ask for one brief clarification instead of describing the canvas.",
